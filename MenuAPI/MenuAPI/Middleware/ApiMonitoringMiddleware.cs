...
using MenuAPI.Data;//använd era bibliotek här 
using MenuAPI.Models;//använd era bibliotek här 
...

{
    ...
    public async Task Invoke(HttpContext context, MenuDbContext dbContext)
