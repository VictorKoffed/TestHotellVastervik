...

{
...

    {
        ...
        private readonly MenuDbContext _context; //dependency injection som gör att vi kan läsa interagera med DB. 



        public StatisticsController(MenuDbContext context)
